...
const PhotoVerification = () => {
    ...
    useEffect(() => {
        const checkExistingVerification = async () => {
            ...
            if (currentUser) {
                const isVerified =
                    await backendService.getPhotoVerificationStatus(
    ...
    const verifyPhoto = async () => {
        ...
        try {
            ...
            // Manual verification - always succeed for demo
            const currentUser = blockchainSystem.getCurrentUser();
            if (!currentUser) {
            ...
            // Save photo verification to blockchain
            const response = await blockchainSystem.savePhotoVerification(
                photo
            );
            ...
            if (response.success) {
                ...
                throw new Error(
                    response.message || "Failed to save photo verification"
                );
            }
        } catch (error) {
            ...
            <CardContent className="space-y-6">
                    ...
                    {isPhotoVerified && storedPhoto ? (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                <div className="bg-green-500/80 text-white px-4 py-2 rounded-md flex items-center mb-2">
                                    <Check className="h-5 w-5 mr-2" />
                                    Photo Verified
                                </div>
                                <div className="bg-blue-500/80 text-white px-4 py-2 rounded-md">
                                    {verificationMessage}
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="bg-primary/10 p-4 rounded-md">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Your photo helps us verify your identity and secure your
                        account. This prevents unauthorized access and protects
                        your digital assets.
                    </p>
                </div>
            </CardContent>
