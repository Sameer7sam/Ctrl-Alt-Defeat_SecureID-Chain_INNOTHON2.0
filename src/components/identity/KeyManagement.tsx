...
const KeyManagement = () => {
  ...
  const [copySuccess, setCopySuccess] = useState<'public' | 'private' | null>(null);
  ...
  const handleGenerateKeyPair = async () => {
    ...
    try {
      const generatedKeyPair = await walletService.generateSecureKeyPair(password);
    ...
    <>
      <Card className="bg-card/60 backdrop-blur-md border-primary/20 shadow-lg overflow-hidden">
        <CardHeader>
          ...
          <CardDescription>
            Generate and manage your secure identity keys for blockchain transactions
          </CardDescription>
        </CardHeader>
              ...
              <div className="bg-primary/10 p-3 rounded-md mt-4">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    <p className="mt-1">
                      Your private key is the master key to your identity. Never share it with anyone,
                      and store your password in a secure place.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="mt-1 text-muted-foreground">
                      This is the only time your private key will be shown. Make sure to save it in a secure location.
                      If you lose this key, you will lose access to your identity and assets.
                    </p>
                  </div>
                </div>
              </div>
